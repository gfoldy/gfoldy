...
const styles = StyleSheet.create({
  ...
  section: { color: T.textDim, fontFamily: 'Manrope_700Bold', fontSize: 12, fontWeight: '700', letterSpacing: 1, textTransform: 'uppercase', marginTop: 22, marginBottom: 10 },
  ...
  statV: { color: T.text, fontFamily: 'BricolageGrotesque_800ExtraBold', fontSize: 18, fontWeight: '800' },
  statL: { color: T.textFaint, fontFamily: 'Manrope_400Regular', fontSize: 10, marginTop: 2 },
  mesoHead: { color: T.gold, fontFamily: 'BricolageGrotesque_800ExtraBold', fontSize: 16, fontWeight: '800' },
  ...
  barLabel: { color: T.text, fontFamily: 'Manrope_400Regular', fontSize: 13, width: 78 },
  ...
  planM: { color: T.text, fontFamily: 'Manrope_600SemiBold', fontSize: 13, fontWeight: '600', width: 74 },
  planRec: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: radii.pill, borderWidth: 1, flexShrink: 1 },
  planRecText: { fontFamily: 'Manrope_700Bold', fontSize: 11, fontWeight: '700' },
  planNext: { color: T.textDim, fontFamily: 'Manrope_700Bold', fontSize: 12, fontWeight: '700', marginLeft: 'auto' },
  pbRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6 },
  pbEx: { color: T.text, fontFamily: 'Manrope_400Regular', fontSize: 14, flexShrink: 1 },
  pbVal: { color: T.textDim, fontFamily: 'Manrope_600SemiBold', fontSize: 13, fontWeight: '600' },
  btnGold: { backgroundColor: T.gold, borderRadius: radii.md, paddingVertical: 12, alignItems: 'center', marginTop: 12 },
  btnGoldText: { color: T.goldInk, fontFamily: 'Manrope_700Bold', fontWeight: '800' },
  btnGhost: { borderWidth: 1, borderColor: T.border, borderRadius: radii.md, paddingVertical: 12, alignItems: 'center', marginTop: 12 },
  btnGhostText: { color: T.text, fontFamily: 'Manrope_700Bold', fontWeight: '700' },
});
