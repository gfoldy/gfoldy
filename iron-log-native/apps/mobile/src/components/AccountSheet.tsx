...
const styles = StyleSheet.create({
  ...
  title: { color: T.text, fontFamily: 'BricolageGrotesque_800ExtraBold', fontSize: 18, fontWeight: '800' },
  close: { color: T.textDim, fontFamily: 'Manrope_600SemiBold', fontWeight: '600' },
  note: { color: T.textFaint, fontFamily: 'Manrope_400Regular', fontSize: 13, lineHeight: 19, marginBottom: 12 },
  hello: { color: T.text, fontFamily: 'Manrope_400Regular', fontSize: 15, marginBottom: 8 },
  gold: { color: T.gold, fontFamily: 'Manrope_700Bold', fontWeight: '800' },
  ...
  ghostText: { color: T.text, fontFamily: 'Manrope_700Bold', fontWeight: '700' },
  link: { color: T.gold, textAlign: 'center', marginTop: 14, fontFamily: 'Manrope_600SemiBold', fontWeight: '600' },
  err: { color: T.red, marginTop: 12, fontFamily: 'Manrope_400Regular', fontSize: 13 },
  ok: { color: T.green, marginTop: 10, fontFamily: 'Manrope_400Regular', fontSize: 13, textAlign: 'center' },
});
