...
const styles = StyleSheet.create({
  muted: { color: T.textFaint, fontFamily: 'Manrope_400Regular', fontSize: 14, lineHeight: 20, padding: 8 },
  ...
  time: { color: T.textFaint, fontFamily: 'Manrope_400Regular', fontSize: 12 },
  body: { color: T.textDim, fontFamily: 'Manrope_400Regular', fontSize: 14, marginTop: 4 },
  muscles: { color: T.gold, fontFamily: 'Manrope_400Regular', fontSize: 12, marginTop: 4 },
  comments: { color: T.textDim, fontFamily: 'Manrope_400Regular', fontSize: 13, marginTop: 10 },
  ...
  cName: { color: T.text, fontFamily: 'Manrope_700Bold', fontSize: 13, fontWeight: '700' },
  cBody: { color: T.textDim, fontFamily: 'Manrope_400Regular', fontSize: 14, marginTop: 2 },
