...
const styles = StyleSheet.create({
  ...
  createText: { color: T.goldInk, fontFamily: 'Manrope_700Bold', fontWeight: '800' },
  h: { color: T.textDim, fontFamily: 'Manrope_700Bold', fontSize: 12, fontWeight: '700', letterSpacing: 1, textTransform: 'uppercase', marginTop: 20, marginBottom: 10 },
  muted: { color: T.textFaint, fontFamily: 'Manrope_400Regular', fontSize: 14, paddingVertical: 4 },
  ...
  lock: { fontFamily: 'Manrope_400Regular', fontSize: 12 },
  rowDesc: { color: T.textDim, fontFamily: 'Manrope_400Regular', fontSize: 12, marginTop: 3 },
  count: { color: T.textDim, fontFamily: 'Manrope_400Regular', fontSize: 13 },
  ...
  title: { color: T.text, fontFamily: 'BricolageGrotesque_800ExtraBold', fontSize: 18, fontWeight: '800', marginBottom: 14 },
  in: { backgroundColor: T.bgElev2, color: T.text, borderRadius: radii.sm, paddingHorizontal: 12, paddingVertical: 12, fontFamily: 'Manrope_400Regular', fontSize: 15, marginBottom: 10 },
  switchRow: { flexDirection: 'row', alignItems: 'center', gap: 12, marginVertical: 8 },
  swLabel: { color: T.text, fontFamily: 'Manrope_600SemiBold', fontSize: 15, fontWeight: '600' },
  swSub: { color: T.textFaint, fontFamily: 'Manrope_400Regular', fontSize: 12, marginTop: 2 },
