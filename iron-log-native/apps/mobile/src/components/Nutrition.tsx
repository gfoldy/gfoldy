...
const styles = StyleSheet.create({
  ...
  section: { color: T.textDim, fontFamily: 'Manrope_700Bold', fontSize: 12, fontWeight: '700', letterSpacing: 1, textTransform: 'uppercase' },
  streak: { color: T.gold, fontFamily: 'Manrope_700Bold', fontSize: 12, fontWeight: '700' },
  card: { backgroundColor: T.bgElev, borderRadius: radii.lg, borderWidth: 1, borderColor: T.border, padding: 14 },
  nrow: { marginBottom: 10 },
  nlab: { color: T.text, fontFamily: 'Manrope_400Regular', fontSize: 14, marginBottom: 6 },
  b: { fontFamily: 'Manrope_700Bold', fontWeight: '800' },
  ...
  inSm: { backgroundColor: T.bgElev2, color: T.text, borderRadius: radii.sm, paddingHorizontal: 8, paddingVertical: 8, width: 70, fontFamily: 'Manrope_400Regular', fontSize: 14 },
  addBtn: { backgroundColor: T.gold, borderRadius: radii.sm, paddingHorizontal: 12, paddingVertical: 9 },
  addBtnText: { color: T.goldInk, fontWeight: '800', fontFamily: 'BricolageGrotesque_800ExtraBold', fontSize: 13 },
  ...
  mealLbl: { color: T.text, fontFamily: 'Manrope_400Regular', fontSize: 13, flex: 1 },
  mealMacros: { color: T.textDim, fontFamily: 'Manrope_400Regular', fontSize: 12 },
  x: { color: T.textFaint, fontFamily: 'Manrope_400Regular', fontSize: 13, paddingHorizontal: 4 },
  link: { color: T.gold, fontFamily: 'Manrope_600SemiBold', fontSize: 13, fontWeight: '600', marginTop: 8 },
  ...
  modalTitle: { color: T.text, fontFamily: 'BricolageGrotesque_800ExtraBold', fontSize: 18, fontWeight: '800', marginBottom: 14 },
  fieldLbl: { color: T.textDim, fontFamily: 'Manrope_400Regular', fontSize: 12, marginBottom: 5 },
  in: { backgroundColor: T.bgElev2, color: T.text, borderRadius: radii.sm, paddingHorizontal: 10, paddingVertical: 10, fontFamily: 'Manrope_400Regular', fontSize: 15 },
  saveBtn: { backgroundColor: T.gold, borderRadius: radii.md, paddingVertical: 12, alignItems: 'center', marginTop: 16 },
  saveBtnText: { color: T.goldInk, fontFamily: 'Manrope_700Bold', fontWeight: '800' },
  cancelBtn: { paddingVertical: 12, alignItems: 'center', marginTop: 6 },
  cancelText: { color: T.textDim, fontFamily: 'Manrope_600SemiBold', fontWeight: '600' },
});
