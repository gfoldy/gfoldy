...
const styles = StyleSheet.create({
  ...
  back: { color: T.gold, fontFamily: 'Manrope_600SemiBold', fontSize: 16, fontWeight: '600', width: 60 },
  title: { color: T.text, fontFamily: 'BricolageGrotesque_800ExtraBold', fontSize: 17, fontWeight: '800', flex: 1, textAlign: 'center' },
  desc: { color: T.textDim, fontFamily: 'Manrope_400Regular', fontSize: 13, padding: 14 },
  ...
  tabText: { color: T.textDim, fontWeight: '600', fontFamily: 'Manrope_600SemiBold', fontSize: 13 },
  tabTextOn: { color: T.goldInk },
  bubbleRow: { marginBottom: 10 },
  msgName: { color: T.textFaint, fontFamily: 'Manrope_400Regular', fontSize: 11, marginBottom: 2, marginLeft: 4 },
  ...
  msgText: { color: T.text, fontFamily: 'Manrope_400Regular', fontSize: 14 },
  msgTime: { color: T.textFaint, fontFamily: 'Manrope_400Regular', fontSize: 10, marginTop: 2, marginHorizontal: 4 },
  ...
  sendText: { color: T.goldInk, fontFamily: 'Manrope_700Bold', fontWeight: '800' },
  invite: { backgroundColor: T.goldSoft, borderRadius: radii.md, padding: 12, marginBottom: 14 },
  inviteLabel: { color: T.textDim, fontFamily: 'Manrope_400Regular', fontSize: 12 },
  inviteCode: { color: T.goldLt, fontFamily: 'BricolageGrotesque_800ExtraBold', fontSize: 18, fontWeight: '800', letterSpacing: 1, marginTop: 4 },
  ...
  name: { color: T.text, fontFamily: 'Manrope_600SemiBold', fontSize: 15, fontWeight: '600' },
  user: { color: T.textFaint, fontFamily: 'Manrope_400Regular', fontWeight: '400' },
  owner: { color: T.gold, fontFamily: 'Manrope_700Bold', fontSize: 11, fontWeight: '700' },
  leave: { borderWidth: 1, borderColor: T.red, borderRadius: radii.md, paddingVertical: 12, alignItems: 'center', marginTop: 20 },
  leaveText: { color: T.red, fontFamily: 'Manrope_700Bold', fontWeight: '700' },
});
