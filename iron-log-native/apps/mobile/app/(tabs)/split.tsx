...
const styles = StyleSheet.create({
  ...
  muted: { color: T.textFaint, fontFamily: 'Manrope_400Regular', fontSize: 14, marginBottom: 8 },
  ...
  dayName: { color: T.text, fontFamily: 'BricolageGrotesque_800ExtraBold', fontSize: 16, fontWeight: '800' },
  dayMeta: { color: T.textFaint, fontFamily: 'Manrope_400Regular', fontSize: 12 },
  ...
  exName: { color: T.text, fontFamily: 'Manrope_400Regular', fontSize: 15 },
  exMeta: { color: T.textFaint, fontFamily: 'Manrope_400Regular', fontSize: 12, marginTop: 2 },
  remove: { color: T.textDim, fontFamily: 'Manrope_700Bold', fontSize: 14, fontWeight: '700', paddingHorizontal: 6 },
  addLink: { color: T.gold, fontFamily: 'Manrope_600SemiBold', fontSize: 13, fontWeight: '600' },
  ...
  modalTitle: { color: T.text, fontFamily: 'BricolageGrotesque_800ExtraBold', fontSize: 18, fontWeight: '800' },
